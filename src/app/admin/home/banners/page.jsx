...
const AdminHomeBannersPage = () => {
  ...
  const fetchBanners = async () => {
    ...
    console.log(data, "home page banners")
  ...
  return (
    <>
      <AppSidebar activeTitle="Home" activeSubtitle="Home Banners" />
      <main className="w-full">
        ...
        <div className="p-4">
          <Table className={"border"}>
            <TableCaption>List of home page banners.</TableCaption>
