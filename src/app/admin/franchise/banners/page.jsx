...
const AdminFranchiseBannersPage = () => {
  ...
  const fetchBanners = async () => {
    ...
    const franchiseBanners = data
      .filter((b) => b.page === "franchise")
      .sort((a, b) => a.orderIndex - b.orderIndex);

    setBanners(franchiseBanners);
    setOriginalBanners(franchiseBanners);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("page", "franchise");
  ...
  return (
    <>
      <AppSidebar activeTitle="Franchise" activeSubtitle="Franchise Banners" />
      <main className="w-full">
        <div className="Header w-full flex items-center justify-between px-4 py-2 border-b">
          ...
          <span className="flex gap-2 font-semibold text-gray-500">
            ...
            <span>&gt;</span>
            <span className="hover:text-black">Franchise</span>
            <span>&gt;</span>
            <a href="/admin/franchise/banners" className="text-black">
              Banners
            </a>
          </span>
        ...
        <div className="p-4">
          <Table className={"border"}>
            <TableCaption>List of franchise page banners.</TableCaption>
...
export default AdminFranchiseBannersPage;
