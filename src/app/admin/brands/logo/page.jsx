...
const AdminBrandsPage = () => {
  ...
  const handleEdit = async (e) => {
    ...
    const formData = new FormData();
    formData.append("name", editForm.title);
    ...
    try {
      ...
      // Reset form
      setEditForm({ id: null, name: "", image: null });
    } catch (error) {
  ...
  const handleDelete = async (bannerId) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`http://localhost:4005/api/brands/${bannerId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`, // ✅ REQUIRED
        },
      ...
      <main className="w-full">
        ...
        <div className="p-4">
          <Table className={"border"}>
            <TableCaption>List of brand page brands.</TableCaption>
                          ...
                          <Button
                            ...
                            onClick={() =>
                              setEditForm({
                                ...
                                title: banner.name, // ✅ preload title
