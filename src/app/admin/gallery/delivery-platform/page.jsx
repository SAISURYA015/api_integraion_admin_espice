...
const AdminGalleryDeliveryPartnerLinksPage = () => {
  ...
  //   formData.append("dunzo", addForm.dunzo);
  ...
  //     // Reset form
  //     setAddForm({ name: "", facebook:"", youtube:"", dunzo:"", instagram:"" });
  //   } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    const formData = new FormData();
    formData.append("name", addForm.name);
    formData.append("swiggy", addForm.swiggy);
    formData.append("zomato", addForm.zomato);
    formData.append("dunzo", addForm.dunzo);
    formData.append("own_delivery", addForm.own_delivery);
    formData.append("own_delivery_icon", addForm.own_delivery_icon);
    formData.append("page", "brands"); // 🔥 REQUIRED
    ...
    try {
      ...
      toast.success("Delivery links added");
      fetchBrands();
      setAddForm({
        name: "",
        swiggy: "",
  ...
  //   formData.append("dunzo", editForm.dunzo);
  ...
  //    // Reset form
  //     setEditForm({ name: "", facebook:"", youtube:"", dunzo:"", instagram:"" });
  //   } catch (error) {
  ...
  const handleEdit = async (e) => {
    ...
    const formData = new FormData();
    formData.append("name", editForm.name);
    formData.append("swiggy", editForm.swiggy);
    formData.append("zomato", editForm.zomato);
    formData.append("dunzo", editForm.dunzo);
    formData.append("own_delivery", editForm.own_delivery);
    formData.append("own_delivery_icon", editForm.own_delivery_icon);
    formData.append("page", "brands");

    try {
      const token = localStorage.getItem("token");
      const res = await fetch(
        `http://localhost:4005/api/brands/${editForm.id}`,
        {
          method: "PUT",
                ...
                <div className="grid gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      value={addForm.swiggy}
                      onChange={(e) =>
                        setAddForm({ ...addForm, swiggy: e.target.value })
                      }
                    />
                  </div>
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      value={addForm.zomato}
                      onChange={(e) =>
                        setAddForm({ ...addForm, zomato: e.target.value })
                      }
                    />
                  </div>
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      value={addForm.dunzo}
                      onChange={(e) =>
                        setAddForm({ ...addForm, dunzo: e.target.value })
                      }
                    />
                  </div>
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      value={addForm.own_delivery}
                      onChange={(e) =>
                        setAddForm({ ...addForm, own_delivery: e.target.value })
                      }
                    />
                  </div>
                  <div className="grid gap-2">
...
export default AdminGalleryDeliveryPartnerLinksPage;