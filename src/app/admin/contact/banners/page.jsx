...
const AdminContactBannersPage = () => {
  ...
  const fetchBanners = async () => {
    ...
    const contactBanners = data
      .filter((b) => b.page === "contact")
      .sort((a, b) => a.orderIndex - b.orderIndex);

    setBanners(contactBanners);
    setOriginalBanners(contactBanners);
  };
  ...
  return (
    <>
      <AppSidebar activeTitle="Contact" activeSubtitle="Contact Banners" />
      <main className="w-full">
        <div className="Header w-full flex items-center justify-between px-4 py-2 border-b">
          ...
          <span className="flex gap-2 font-semibold text-gray-500">
            ...
            <span>&gt;</span>
            <a href="/admin/contact/banners" className="text-black">
              Banners
            </a>
          </span>
        ...
        <div className="p-4">
          <Table className={"border"}>
            <TableCaption>List of contact page banners.</TableCaption>
...
export default AdminContactBannersPage;
